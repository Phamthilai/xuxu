		        ...
		        <div id="main-content">
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<div class="metabox">
							...
							<span class="entry-comments"> <?php comments_number( __('0 Comment', 'hotel-resort'), __('0 Comments', 'hotel-resort'), __('% Comments', 'hotel-resort') ); ?> </span>
						</div>
						...
						wp_link_pages( array(
							'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'hotel-resort' ) . '</span>',
							'after'       => '</div>',
							'link_before' => '<span>',
							'link_after'  => '</span>',
							'pagelink'    => '<span class="screen-reader-text">' . __( 'Page', 'hotel-resort' ) . ' </span>%',
						...
						if ( is_singular( 'attachment' ) ) {
							...
							the_post_navigation( array(
								'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'hotel-resort' ),
							) );
						} elseif ( is_singular( 'post' ) ) {
							// Previous/next post navigation.
							the_post_navigation( array(
								'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next page', 'hotel-resort' ) . '</span> ' .
									'<span class="screen-reader-text">' . __( 'Next post:', 'hotel-resort' ) . '</span> ' .
									'<span class="post-title">%title</span>',
								'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous page', 'hotel-resort' ) . '</span> ' .
									'<span class="screen-reader-text">' . __( 'Previous post:', 'hotel-resort' ) . '</span> ' .
									'<span class="post-title">%title</span>',
							) );
						}
			...
			<?php }else if($layout == 'Four Columns'){?>
				<div class="row">
			    	<div class="col-md-3 col-sm-3" id="sidebar"><?php dynamic_sidebar('sidebar-2'); ?></div>
			       	<div class="col-md-3 col-sm-3" id="main-content">
						<?php while ( have_posts() ) : the_post(); ?>
							<h1><?php the_title();?></h1>
							<div class="metabox">
								<span class="entry-date"><?php echo esc_html( get_the_date() ); ?></span>
